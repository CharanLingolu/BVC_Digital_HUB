...
import adminAPI from "../../services/adminApi"; // ✅ Imported API

const Jobs = () => {
  const [jobs, setJobs] = useState([]); // ✅ Start empty, fetch from DB
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#090c10] text-slate-900 dark:text-white font-sans selection:bg-cyan-500/30 transition-colors duration-300 relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Cyan & Blue blobs for a professional/tech vibe */}
      ...
      <main className="relative z-10 pt-28 px-6 max-w-7xl mx-auto pb-20">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 animate-fade-in-up">
          ...
          {/* Create Button - Fancy Gradient */}
          <button
            onClick={() => handleOpenModal()}
            className="group relative overflow-hidden rounded-2xl py-4 px-8 bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 text-white font-bold text-lg shadow-xl shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all duration-300 hover:-translate-y-1 active:scale-95 flex items-center gap-3"
          >
        ...
        {/* ================= TOOLBAR (Search) ================= */}
        <div
          className="sticky top-24 z-30 mb-10 p-2 rounded-[1.5rem] bg-white/70 dark:bg-[#161b22]/70 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-lg shadow-cyan-500/5 animate-fade-in-up"
...
const JobCard = ({ job, onEdit, onDelete }) => {
  ...
  return (
    <div className="group relative bg-white/60 dark:bg-[#161b22]/60 backdrop-blur-xl rounded-[2.5rem] border border-white/50 dark:border-white/5 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyan-500/20 flex flex-col h-full">
      <div className="absolute inset-0 rounded-[2.5rem] border-2 border-transparent group-hover:border-cyan-500/30 transition-colors duration-500 pointer-events-none z-20"></div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md p-4 animate-in fade-in duration-300">
      <div className="relative w-full max-w-2xl bg-white/80 dark:bg-[#161b22]/90 backdrop-blur-2xl rounded-[2.5rem] shadow-3xl overflow-hidden border border-white/20 flex flex-col max-h-[90vh]">
        ...
        >
          <div className="space-y-6">
            ...
            <div className="group">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Key responsibilities, skills required, etc..."
                rows={4}
          ...
          <button
            type="submit"
            className="w-full mt-8 py-4 rounded-2xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-black text-lg shadow-xl shadow-cyan-500/25 hover:shadow-cyan-500/40 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 active:scale-[0.98]"
          >
            <Save size={20} />
